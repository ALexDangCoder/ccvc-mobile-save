...
class ThemMoiYCHoTroTablet extends StatefulWidget {
  final HoTroKyThuatCubit cubit;

  const ThemMoiYCHoTroTablet({
    Key? key,
    required this.cubit,
  }) : super(key: key);

  @override
  State<ThemMoiYCHoTroTablet> createState() => _ThemMoiYCHoTroTabletState();
}

class _ThemMoiYCHoTroTabletState extends State<ThemMoiYCHoTroTablet> {
