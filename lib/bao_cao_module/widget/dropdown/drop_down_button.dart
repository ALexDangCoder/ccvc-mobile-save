...
class _DropdownMenuItemButtonState<T>
  ...
  void _handleOnTap() {
    final DropdownMenuItemWidget<T> dropdownMenuItem =
...
class _MenuItem<T> extends SingleChildRenderObjectWidget {
  ...
  final DropdownMenuItemWidget<T>? item;
...
class DropdownMenuItemWidget<T> extends _DropdownMenuItemContainer {
  /// Creates an item for a dropdown menu.
  ///
  /// The [child] argument is required.
...
class DropdownButtonWidget<T> extends StatefulWidget {
  ...
  DropdownButtonWidget({
    ...
    // DropdownButtonFormField.
          ...
          items == null ||
              items.isEmpty ||
              value == null ||
              items.where((DropdownMenuItemWidget<T> item) {
  ...
  final List<DropdownMenuItemWidget<T>>? items;
...
class _DropdownButtonState<T> extends State<DropdownButtonWidget<T>>
  ...
  @override
  void didUpdateWidget(DropdownButtonWidget<T> oldWidget) {
  ...
  void _updateSelectedIndex() {
    if (widget.items == null ||
        ...
        (widget.value == null &&
            widget.items!
                .where((DropdownMenuItemWidget<T> item) =>
    ...
    assert(widget.items!
            .where(
                (DropdownMenuItemWidget<T> item) => item.value == widget.value)
            .length ==
        1);
...
class DropdownButtonFormField<T> extends FormField<T> {
  ...
  DropdownButtonFormField({
    Key? key,
    required List<DropdownMenuItemWidget<T>>? items,
