...
class BieuDoTrangThaiTheoLoaiTablet extends StatefulWidget {
  final DanhSachCubit cubit;
  final List<ChartData> chartData;
  final Function(String) ontap;

  const BieuDoTrangThaiTheoLoaiTablet({
    Key? key,
    required this.cubit,
  ...
  @override
  _BieuDoTrangThaiTheoLoaiTabletState createState() =>
      _BieuDoTrangThaiTheoLoaiTabletState();
}

class _BieuDoTrangThaiTheoLoaiTabletState
    extends State<BieuDoTrangThaiTheoLoaiTablet> {
  @override
  void initState() {
    super.initState();
  }
