...
class TableCalendarTablet<T> extends StatefulWidget {
  ...
  @override
  _TableCalendarTabletState<T> createState() => _TableCalendarTabletState<T>();
}

class _TableCalendarTabletState<T> extends State<TableCalendarTablet<T>> {
