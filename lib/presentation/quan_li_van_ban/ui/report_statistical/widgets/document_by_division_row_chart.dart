...
class _DocumentByDivisionRowChartState
  ...
  Widget build(BuildContext context) {
    return widget.data.isEmpty
        ...
        : Column(
            children: [
              if (widget.data.first.listData.length > 1)
                Padding(
                  ...
                  child: GridView.count(
                    ...
                    crossAxisSpacing: 10,
                    children: List.generate(widget.data.first.listData.length,
                        (index) {
              ...
              SizedBox(
                height: widget.data.first.listData.length > 1 ? 24 : 0,
              ),
              Row(
  ...
  double getMaxRow(List<RowChartData> listData) {
    ...
    heSo = 300/value == 0 ? 5 : 300 / value;
    scale = (40 / heSo).round() == 0 ? 10 : (40 / heSo).round();
