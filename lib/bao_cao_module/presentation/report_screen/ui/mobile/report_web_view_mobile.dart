...
class ReportWebViewMobile extends StatefulWidget {
  const ReportWebViewMobile({
    Key? key,
    required this.cubit,
  ...
  @override
  State<ReportWebViewMobile> createState() => _ReportWebViewMobileState();
}

class _ReportWebViewMobileState extends State<ReportWebViewMobile> {
  @override
  void initState() {
