...
class NhacLichWidget extends StatefulWidget {
  ...
  final bool isSelectedBtn;

  const NhacLichWidget({
    Key? key,
...
class _ExpandedSectionState extends State<NhacLichWidget>
  ...
  @override
  void didUpdateWidget(covariant NhacLichWidget oldWidget) {
              ...
              children: [
                ...
                ...[
                  ContainerToggleWidget(
                    key: UniqueKey(),
                    initData: widget.isSelectedBtn,
                    title: S.current.cong_khai_lich,
                    onChange: (value) {
                      widget.onTogglePressed?.call(value);
                    },
                  ),
                ]
              ],
