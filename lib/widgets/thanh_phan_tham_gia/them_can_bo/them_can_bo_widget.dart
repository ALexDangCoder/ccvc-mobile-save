...
class _ThemCanBoScreenState extends State<ThemCanBoScreen> {
  ...
  Widget itemListDonVi({
    int? index,
    required DonViModel donViModel,
  }) =>
      Padding(
        ...
        child: CanBoWidget(
          onCheckBox: (value) async {
                  ...
                  showDiaLog(
                    ...
                    icon:Container(
                      ...
                      decoration: BoxDecoration(
                        color: APPTHEME.AppTheme.getInstance().colorField().withOpacity(0.1),
            ...
            if (widget.cubit.listPeople.indexWhere(
                  (element) => element.id == donViModel.id,
                ) ==
                -1) {
              widget.themCanBoCubit.selectCanBo(
                donViModel,
