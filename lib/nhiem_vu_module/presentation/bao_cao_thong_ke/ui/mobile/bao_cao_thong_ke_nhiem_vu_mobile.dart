                                    ...
                                    ? ChartWidget(
                                        ...
                                        listData: [
                                          [
                                            ...
                                            ChartData(
                                                'title', 1, chuaThucHienColor),
                                            ChartData(
                                                'title', 3, dangThucHienColor),
                                            ChartData('title', 4, daXuLyColor)
                                          ],
                                          [
                                            ChartData('title', 3, choXuLyColor),
                                            ChartData(
                                                'title', 5, chuaThucHienColor),
                                            ChartData(
                                                'title', 6, dangThucHienColor),
                                            ChartData('title', 4, daXuLyColor)
                                          ],
                                          [
                                          ...
                                          [
                                            ...
                                            ChartData(
                                                'title', 20, chuaThucHienColor),
                                            ChartData(
                                                'title', 21, dangThucHienColor),
                                            ChartData('title', 2, daXuLyColor)
                                          ],
                                          [
                                            ChartData('title', 3, choXuLyColor),
                                            ChartData(
                                                'title', 4, chuaThucHienColor),
                                            ChartData(
                                                'title', 10, dangThucHienColor),
                                          ...
                                          [
                                            ...
                                            ChartData(
                                                'title', 2, chuaThucHienColor),
                                            ChartData(
                                                'title', 5, dangThucHienColor),
                                          ...
                                          [
                                            ChartData(
                                                'title', 11, choXuLyColor),
                                            ChartData(
                                                'title', 11, chuaThucHienColor),
                                            ChartData(
                                                'title', 20, dangThucHienColor),
                                            ChartData('title', 10, daXuLyColor)
                                          ],
                                          [
                                            ChartData('title', 1, choXuLyColor),
                                            ChartData(
                                                'title', 9, chuaThucHienColor),
                                            ChartData(
                                                'title', 22, dangThucHienColor),
                                            ChartData('title', 10, daXuLyColor)
                                          ],
                                          [
                                            ChartData('title', 3, choXuLyColor),
                                          ...
                                          [
                                            ...
                                            ChartData(
                                                'title', 23, chuaThucHienColor),
                                            ChartData(
                                                'title', 1, dangThucHienColor),
                                            ChartData('title', 0, daXuLyColor)
                                          ],
                                        ],
                                        listStatusData: [
