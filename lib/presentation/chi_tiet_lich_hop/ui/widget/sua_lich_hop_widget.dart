        ...
        child: StreamBuilder<ChiTietLichHopModel>(
          ...
          builder: (context, snapshot) {
            ...
            _cubitTaoLichHop.taoLichHopRequest =
                taoHopFormChiTietHopModel(dataDetail);
            return Form(
              key: _formKey,
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        CupertinoMaterialPicker(
                          key: _timerPickerKey,
                          initDateStart:
                              dataDetail.ngayBatDau.convertStringToDate(
                            formatPattern: DateFormatApp.monthDayFormat,
                          ),
                          initDateEnd:
                              dataDetail.ngayKetThuc.convertStringToDate(
                            formatPattern: DateFormatApp.monthDayFormat,
                          ),
                          initTimeEnd: dataDetail.timeTo.convertStringToDate(
                            formatPattern: DateFormatApp.timeFormat,
                          ),
                          initTimeStart:
                              dataDetail.timeStart.convertStringToDate(
                            formatPattern: DateFormatApp.timeFormat,
                          ),
                          isAllDay: dataDetail.isAllDay,
                          onDateTimeChanged: (
                            String timeStart,
                            String timeEnd,
                            String dateStart,
                        ...
                        spaceH5,
                        NhacLichWidget(
                          isSelectedBtn: dataDetail.isCongKhai ?? false,
                        ...
                        LichLapWidget(
                          ...
                          isUpdate: true,
                          initDayPicked: dataDetail.getDays(),
                          initDate:
                              dataDetail.dateRepeat?.convertStringToDate(),
                          listSelect:
                        ...
                        CoQuanChuTri(
                          ...
                          chuTri: dataDetail.chuTriModel,
                          isTrongDonVi: dataDetail.bit_TrongDonVi,
                        ),
                        spaceH24,
                        TextFieldStyle(
                          initValue: dataDetail.noiDung,
                  ...
                  TitleChildWidget(
                    ...
                    child: Column(
                      children: [
                        TextFieldStyle(
                          initValue: dataDetail.chuTriModel.dauMoiLienHe,
                        ...
                        spaceH16,
                        TextFieldStyle(
                          initValue: dataDetail.chuTriModel.soDienThoai,
                    ...
                    onPressed2: () {
                      ...
                      if ((_formKey.currentState?.validate() ?? false) &&
                          (_timerPickerKey.currentState?.validator() ??
                              false)) {
                        _cubitTaoLichHop.createMeeting().then((value) {
                          if (value) {
                            MessageConfig.show(
