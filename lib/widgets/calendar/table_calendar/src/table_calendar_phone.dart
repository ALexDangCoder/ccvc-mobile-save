...
import 'customization/days_of_week_style_phone.dart';
import 'customization/header_style_phone.dart';
import 'shared/utils_phone.dart';
import 'table_calendar_base_phone.dart';
import 'widgets/calendar_header_phone.dart';
import 'widgets/cell_content_phone.dart';
...
class TableCalendarPhone<T> extends StatefulWidget {
  ...
  @override
  _TableCalendarPhoneState<T> createState() => _TableCalendarPhoneState<T>();
}

class _TableCalendarPhoneState<T> extends State<TableCalendarPhone<T>> {
  ...
  @override
  void didUpdateWidget(TableCalendarPhone<T> oldWidget) {
